...
public class ComplexNumber {
    ...
    public static void main(String[] args) {
        ...
        while (choice == 'y' || choice == 'Y') {
            ...
            double sw_real, sw_imaginary;
            System.out.println("1.add\n2.subtract");
            int method = scanner.nextInt();
            switch (method) {
                case 1:
                    System.out.println("enter the values to add ");
                    sw_real = scanner.nextDouble();
                    sw_imaginary = scanner.nextDouble();
                    complexNumber.add(sw_real, sw_imaginary);
                    System.out.println("after addition " + complexNumber.real + " " + complexNumber.imaginary);
                    break;
                case 2:
                    System.out.println("enter the values to subtract ");
                    sw_real = scanner.nextDouble();
                    sw_imaginary = scanner.nextDouble();
                    complexNumber.subtract(sw_real, sw_imaginary);
                    System.out.println("after subtraction " + complexNumber.real + " " + complexNumber.imaginary);
                    break;
                default:
